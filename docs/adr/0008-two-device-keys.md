...
- **Session key**: no user-authentication requirement. Signs sign-in code redemption and token refresh (proof of possession). Routine calls use the 15-minute bearer token (see ADR-0016).
